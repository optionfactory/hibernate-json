...
import net.optionfactory.hj.jackson.reflection.SerializableTypeWrapper.FieldTypeProvider;
import net.optionfactory.hj.jackson.reflection.SerializableTypeWrapper.MethodParameterTypeProvider;
import net.optionfactory.hj.jackson.reflection.SerializableTypeWrapper.TypeProvider;
...
public class ResolvableType implements Serializable {
	...
	public String toString() {
		...
		if (hasGenerics()) {
			result.append('<');
			result.append(Arrays.stream(getGenerics()).map(ResolvableType::toString).collect(Collectors.joining(", ")));
			result.append('>');
		}
